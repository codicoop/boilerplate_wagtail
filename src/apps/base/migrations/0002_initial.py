# Generated by Django 4.0.7 on 2022-08-12 16:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='menu_items', to='base.localizedmainmenu')),
            ],
            options={
